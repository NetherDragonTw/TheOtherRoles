    ...
    class MeetingHudPatch {
        ...
        static void swapperOnClick(int i, MeetingHud __instance) {
            ...
            if (selectedCount == 0) {
                ...
                if (selections[i]) {
                    ...
                    selections[i] = true;
                    renderer.color = Color.yellow;
                    swapperConfirmButtonLabel.text = Helpers.cs(Color.yellow, "確認換票");
                }
            } else if (selectedCount == 2) {
                if (selections[i]) {
                    renderer.color = Color.red;
                    selections[i] = false;
                    swapperConfirmButtonLabel.text = Helpers.cs(Color.red, "確認換票");
                }
            }
        }
        ...
        static void swapperConfirm(MeetingHud __instance) {
            ...
            if (firstPlayer != null && secondPlayer != null) {
                ...
                Swapper.charges--;
                swapperChargesText.text = $"交換對象:: {Swapper.charges}";
            }
        }
